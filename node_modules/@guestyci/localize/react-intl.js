...
var constants = _interopRequireWildcard(require("./react-intl-consts"));
...
function () {
  ...
  (0, _createClass2["default"])(ReactIntlUniversal, [{
    ...
    value: function load(locales) {
      (0, _merge["default"])(this.options.locales, locales);
    }
  }, {
    ...
    value: function loadRemoteScript(lang) {
      ...
      return new Promise(function (resolve) {
        ...
        (0, _loadScript["default"])(localeURL, function (err) {
          if (err && debug) {
