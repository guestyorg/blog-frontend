...
const CalendarTooltipReserved = ({
  data
}) => /*#__PURE__*/React.createElement("div", {
  className: "flex-start d-flex-fill text-white flex-column",
  "data-qa": "calendar-tooltip-reserved"
}, /*#__PURE__*/React.createElement("div", {
  className: "text-left font-weight-bold bb-2 w-100 border-black-dark pb-2 mb-1"
}, data.title), /*#__PURE__*/React.createElement(CalendarTooltipReservedItem, {
  title: "Status",
  value: data.status,
  color: colorFromStatus(data.status)
}), /*#__PURE__*/React.createElement(CalendarTooltipReservedItem, {
  title: "ETA",
...
}), data.money && /*#__PURE__*/React.createElement(CalendarTooltipReservedItem, {
  title: "Payout",
