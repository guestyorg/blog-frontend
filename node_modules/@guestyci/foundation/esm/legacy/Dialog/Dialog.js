...
var Dialog = function Dialog(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Modal, {
    ...
    isOpen: isOpen,
    className: className,
    contentClassName: cn('box-shadow-center-heavy', modalContentClass, _defineProperty({}, "".concat(isXDialog ? 'pb-6 pl-9 pt-4 pr-4' : 'px-9'), !disabledModalContentPadding)),
    "data-qa": "dialog"
    ...
    className: cn("".concat(!disabledModalContentPadding && isXDialog ? 'pr-5 pl-0 pt-0 pb-0' : 'p-0'), 'overflow-y-auto', bodyClassName)
