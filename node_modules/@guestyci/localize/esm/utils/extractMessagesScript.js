...
var extractFromFile = function extractFromFile(fileName) {
  ...
  return _regeneratorRuntime.async(function extractFromFile$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _regeneratorRuntime.awrap(readFile(fileName));

        case 3:
          code = _context.sent;
          _context.next = 6;
          return _regeneratorRuntime.awrap(transform(code, {
            presets: presets,
            plugins: plugins
          }));
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 3;
          return _regeneratorRuntime.awrap(glob(FILES_TO_PARSE));
        ...
        case 3:
          ...
          _context3.next = 8;
          return _regeneratorRuntime.awrap(Promise.all(files.map(function (fileName) {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    _context2.next = 9;
                    return _regeneratorRuntime.awrap(writeFile(translationFileName, prettified));
