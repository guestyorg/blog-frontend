...
var ThreadMessageErrInfo = function ThreadMessageErrInfo(_ref) {
  var messageReason = _ref.messageReason,
      onDelete = _ref.onDelete,
      retrySendMessage = _ref.retrySendMessage,
      tooltip = _ref.tooltip,
      deleteTxt = _ref.deleteTxt,
      retryTxt = _ref.retryTxt;
  return /*#__PURE__*/React.createElement("div", {
    id: "error-message-info",
    className: "message-error-component d-flex align-items-center text-muted justify-content-end",
    "data-qa": "thread-message-err-info"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-red mr-2"
  }, messageReason), /*#__PURE__*/React.createElement(Tooltip, {
    body: tooltip,
    fullWidth: true
    ...
    className: "mx-5",
    onClick: onDelete
  }, deleteTxt), /*#__PURE__*/React.createElement(FlatButton, {
