...
const Moment = ({
  ...
  return React.createElement("div", {
    className: cn('d-flex moment-wrapper', {
      [`text-${color}`]: color
    }, className),
    style: style
  }, fromNow || humanize ? React.createElement(LocalizationContext.Consumer, null, ({
    isEnglish
  }) => React.createElement(Tag, null, dateToFromNow(date, isEnglish))) : React.createElement(React.Fragment, null, format === MomentFormatTypes.Time ? React.createElement(FormattedTime, {
    variant: variant,
    time: date
