...
export var VARIANTS = ['success', 'danger', 'warning', 'redWarning'];
var success = VARIANTS[0],
    danger = VARIANTS[1],
    warning = VARIANTS[2],
    redWarning = VARIANTS[3];
var variants = (_variants = {}, _defineProperty(_variants, success, {
  ...
  fillColor: yellow400
}), _defineProperty(_variants, redWarning, {
  Svg: IcoNotice,
  backgroundColor: red10,
  fillColor: red700
}), _variants);
...
var StatusIndication = function StatusIndication(_ref) {
