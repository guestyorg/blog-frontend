...
var colorArray = colors.map(function (color) {
  return {
...
var Toolbar = function Toolbar(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "rich-text-toolbar px-1 d-flex-fill min-height-35 bb-1 ".concat(theme === Theme.Light ? 'border-gray-lightest bg-white ' : 'border-gray-light bg-gray-lightest'),
