...
var _RichTextEditorToolbarActionButton = _interopRequireDefault(require("./RichTextEditorToolbarActionButton"));
...
var styles = {
  icon: {
    width: 25,
    height: 25,
    borderColor: _colors.grayLightest,
    border: 'none',
...
var colorArray = _richTextEditorConf.colors.map(function (color) {
  return {
...
var Toolbar = function Toolbar(_ref) {
  var toggleInlineType = _ref.toggleInlineType,
      toggleBlockType = _ref.toggleBlockType,
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    className: "rich-text-toolbar px-1 d-flex-fill min-height-35 bb-1 ".concat(theme === _enums.Theme.Light ? 'border-gray-lightest bg-white ' : 'border-gray-light bg-gray-lightest'),
    ...
    dense: true,
    align: "center"
  }, /*#__PURE__*/_react["default"].createElement(_RichTextEditorToolbarItem["default"], null, /*#__PURE__*/_react["default"].createElement(_IconDropdown["default"], {
    color: "transparent",
    svg: BtnRichTextSize,
    ...
    options: _richTextEditorConf.fontSize,
    iconClassName: classes.icon
  })), /*#__PURE__*/_react["default"].createElement(_RichTextEditorToolbarActionButton["default"], {
...
var _default = (0, _reactJss["default"])(styles)(Toolbar);
