...
var Listing = React.forwardRef(function Person(_ref, ref) {
  var _cn;
  ...
  var _ref$img = _ref.img,
      ...
      props = _objectWithoutProperties(_ref, ["img", "name", "description", "multiUnit", "complex", "confirmed", "className", "style", "jss"]);
  ...
  return /*#__PURE__*/React.createElement(Row, _extends({}, props, {
    ...
    src: img,
    className: cn((_cn = {}, _defineProperty(_cn, classes.complex, complex), _defineProperty(_cn, classes.multiUnit, !complex && multiUnit), _cn)),
