...
const NumberPickerArrows = ({
  ...
  return /*#__PURE__*/React.createElement(Col, {
    ...
    "data-qa": "number-picker-arrows"
  }, /*#__PURE__*/React.createElement(Button, {
    className: cn(classes.arrow, classes.upArrow, {
      [classes.disabled]: disableInc
    }),
    disabled: disableInc,
    type: "button",
    onClick: onInc,
    ...
    className: cn(classes.arrow, classes.downArrow, {
      [classes.disabled]: disableDec
    }),
    disabled: disableDec,
    type: "button",
    onClick: onDec,
...
export default NumberPickerArrows;