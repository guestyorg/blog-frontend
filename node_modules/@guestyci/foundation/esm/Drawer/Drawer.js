...
var Drawer = forwardRef(function Drawer(_ref5, ref) {
  ...
  return /*#__PURE__*/React.createElement(Paper, {
    ...
    ref: ref,
    bgColor: bgColor,
    className: cn(classes.root, _defineProperty({}, classes.open, open), _defineProperty({}, classes.close, !open), _defineProperty({}, classes.right, overlay && right), _defineProperty({}, classes.overlay, overlay), _defineProperty({}, classes.fixed, fixed), className),
    style: style,
