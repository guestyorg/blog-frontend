...
const NumberPickerActionButtons = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: cn('flex-center bl-1 border-gray-light flex-column', {
      [classes.btnAsLabelWrapper]: asLabel
    }),
    "data-qa": "number-picker-action-buttons"
    ...
    disabled: disableMax,
    svg: BtnArrowUp,
    className: cn(`${classes.actionButton} ${classes.btnTop}`, {
      [classes.btnAsLabel]: asLabel
    })
  }), /*#__PURE__*/React.createElement(ActionButton, {
    onClick: onDecrement,
    iconWidth: 10,
    ...
    disabled: disableMin,
    svg: BtnArrowDown,
    className: cn(`${classes.actionButton} ${classes.btnBottom}`, {
      [classes.btnAsLabel]: asLabel
    })
  }));
};
...
export default NumberPickerActionButtons;