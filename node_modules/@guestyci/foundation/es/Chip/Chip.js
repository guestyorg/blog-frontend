...
const Chip = React.forwardRef(function Chip(_ref, ref) {
  let {
    value,
    onClear,
    noClear,
    ...
    className
      ...
      props = _objectWithoutPropertiesLoose(_ref, ["value", "onClear", "noClear", "jss", "className"]);
