...
const lightThemeClasses = 'text-white border-white text-hover-blue-dark-theme border-hover-blue-dark-theme';
...
const OutlineButton = (_ref) => {
  let {
    ...
    childrenClassName
      ...
      props = _objectWithoutPropertiesLoose(_ref, ["children", "onClick", "className", "style", "disabled", "isLoading", "theme", "childrenClassName"]);

  return /*#__PURE__*/React.createElement(BaseButton, _extends({
    onClick: onClick,
    className: cn('font-size-sm', className, {
      [lightThemeClasses]: theme === Theme.Light
    }),
    variant: "outline",
    style: style,
    disabled: disabled,
