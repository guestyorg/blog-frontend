...
const Popover = (_ref) => {
  let {
    ...
    id
      ...
      rest = _objectWithoutPropertiesLoose(_ref, ["children", "className", "body", "style", "theme", "containerClassName", "innerClassName", "placement", "offset", "isOpen", "onClose", "fullWidth", "id"]);

  const popoverId = useMemo(() => id || uuid(), [id]);
