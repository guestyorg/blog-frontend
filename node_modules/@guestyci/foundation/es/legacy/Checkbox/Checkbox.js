...
const Checkbox = ({
  ...
  return /*#__PURE__*/React.createElement(Row, {
    align: "center",
    spacing: "sm",
    className: cn('fill-muted text-muted', 'transition-all', disabled ? 'disabled' : 'clickable', {
    ...
    checked: checked,
    onChange: noop,
    className: cn('d-none', 'pointer-events-none', inputClassName),
    style: inputStyle,
    name: name,
    value: value
  }), icon && checked ? checkedIcon : icon, !icon && /*#__PURE__*/React.createElement(SvgIcon, {
    svg: svgIcon,
    noFill: true,
    height: 15,
    width: 15
  }), children && /*#__PURE__*/React.createElement("div", {
    className: cn('checkbox-children', classes.checkboxChildren)
  }, children));
};
