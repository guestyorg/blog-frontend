...
var useStyles = (0, _createStyles["default"])(function (theme) {
  ...
  name: 'DropdownClearButton'
});

var DropdownClearButton = function DropdownClearButton(_ref) {
  var show = _ref.show,
      onClick = _ref.onClick,
      asSuffix = _ref.asSuffix;
  var classes = useStyles();
  return /*#__PURE__*/_react["default"].createElement(_Fade["default"], {
    show: show,
    mountOnEnter: true,
    "data-qa": "dropdown-clear-button"
  }, /*#__PURE__*/_react["default"].createElement(_IconButton["default"], {
    className: classes.root,
    component: "span",
    size: "xs",
    position: asSuffix ? 'suffix' : undefined,
    onClick: onClick
  }, /*#__PURE__*/_react["default"].createElement(BtnDelete, {
    width: 12,
    height: 12
  })));
};

var _default = DropdownClearButton;
