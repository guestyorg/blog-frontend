...
var isStart = function isStart(position) {
  return position === 'start';
};

var iconForType = function iconForType(type) {
  switch (type) {
    case 'warning':
...
var Alert = function Alert(_ref) {
  var message = _ref.message,
      ...
      type = _ref.type;
  var isIconStart = isStart(iconPosition);
  return /*#__PURE__*/React.createElement(Fragment, null, message ? /*#__PURE__*/React.createElement(Row, {
    spacing: "sm"
  }, isIconStart && iconForType(type), /*#__PURE__*/React.createElement(TextField, null, message), !isIconStart && iconForType(type)) : null);
};
