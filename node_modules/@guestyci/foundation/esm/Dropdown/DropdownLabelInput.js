...
var DropdownLabelInput = React.forwardRef(function DropdownLabelInput(_ref, ref) {
  var _cn2;
  ...
  var value = _ref.value,
      ...
      props = _objectWithoutProperties(_ref, ["value", "className", "open", "renderSelected", "placeholder", "renderComponent", "dataKey", "variant"]);
  ...
  return /*#__PURE__*/React.createElement(Row, _extends({
    ...
    className: cn(_defineProperty({}, classes.active, !isEmpty(value)))
    ...
    svg: BtnArrowUp,
    className: cn(classes.icon, (_cn2 = {}, _defineProperty(_cn2, classes.rotate, !open), _defineProperty(_cn2, classes.active, open), _cn2)),
    width: 10,
    height: 10
  }));
});
